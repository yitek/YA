...
(function (factory) {
    ...
    var ObservableObjectTest = /** @class */ (function () {
        function ObservableObjectTest() {
        }
        ObservableObjectTest.prototype.base = function (assert_statement) {
            var data = {
                id: 1,
                title: "YA framework"
            };
        ...
        ObservableObjectTest.prototype.deep = function (assert_statement) {
        ...
        ], ObservableObjectTest.prototype, "base", null);
        __decorate([
            doct_1.doct({
                title: "非平坦对象"
            })
        ], ObservableObjectTest.prototype, "deep", null);
        ObservableObjectTest = __decorate([
            doct_1.doct({
                title: "YA.ObservableObject",
                descriptions: '可观察的对象代理'
            })
