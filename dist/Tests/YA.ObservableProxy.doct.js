...
(function (factory) {
    ...
    var ObservableProxyTest = /** @class */ (function () {
        function ObservableProxyTest(cdoc) {
            cdoc.description = "\u53EF\u89C2\u5BDF\u7684\u6570\u636E\u4EE3\u7406\uFF0C\u53EF\u4EE5\u901A\u8FC7$get/$set\u6765\u64CD\u4F5C\u5B83\u7684\u503C";
            cdoc.usage("基本用法", function (assert_statement) {
                //0 定义被代理的数据
                var raw_data = 12;
                //1 创建一个数据代理,它的第一个参数为读/写原始值的函数
                var proxy = new YA.ObservableProxy(function (val) { return val === undefined ? raw_data : raw_data = val; });
            ...
            cdoc.usage("成员不可枚举", "所有成员enumerable==false", function (assert_statement) {
                //1 创建一个可观察对象 
                var raw_data = 12;
                var ob = new YA.ObservableProxy(function (val) { return val === undefined ? raw_data : raw_data = val; }, undefined, {});
                //2 做一些操作
        ...
        ObservableProxyTest = __decorate([
            YA_doct_1.doct("YA.ObservableProxy")
        ], ObservableProxyTest);
        return ObservableProxyTest;
    }());
    exports.ObservableProxyTest = ObservableProxyTest;
});
//# sourceMappingURL=YA.ObservableProxy.doct.js.map