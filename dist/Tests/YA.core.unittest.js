...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../YA.core", "../YA.core"], factory);
    }
    ...
    var testObservable = function (assert, info) {
    };
    var testObservableProxy = function (assert, info) {
        var target = { x: 1 };
        var proxy = new YA_core_2.Observable(function (value) { return (value === undefined) ? target.x : target.x = value; });
    ...
    var testObserableObject = function (assert, info) {
        var target = {
            name: "yiy",
            gender: 1,
            age: 38,
        ...
        var propAge;
        try {
            YA_core_2.Observable.mode = YA_core_2.ObservableModes.Proxy;
            propAge = proxy.age;
        }
        finally {
            YA_core_2.Observable.mode = YA_core_2.ObservableModes.Default;
        }
        assert(true, propAge instanceof YA_core_2.Observable, "当ValueProxy.gettingProxy开关打开时，属性返回的的是代理对象本身");
        var evtArgs;
    ...
    var testComponent = function (assert, info) {
        var model = createData();
        var item = model.rows[0];
        var rows = [];
        for (var i = 0; i < 10; i++) {
            var newItem = {};
            for (var n in item)
        ...
        var SampleComponent = /** @class */ (function () {
            ...
            SampleComponent.prototype.template = function () {
                return YA_core_1.default.ELEMENT("div", null,
                    ...
                    YA_core_1.default.ELEMENT("table", { border: "1" },
                        YA_core_1.default.ELEMENT("thead", null,
                            YA_core_1.default.ELEMENT("tr", null,
                                YA_core_1.default.ELEMENT("th", null, "Name"),
                                YA_core_1.default.ELEMENT("th", null, "Author"))),
                        YA_core_1.default.ELEMENT("tbody", { repeat: [this.model.rows, this.rowItem] },
                            YA_core_1.default.ELEMENT("tr", null,
                                YA_core_1.default.ELEMENT("td", null, this.rowItem.name),
                                YA_core_1.default.ELEMENT("td", null, this.rowItem.author.email)))));
            };
            ;
            SampleComponent.prototype.nameChanged = function (e) {
                ...
                for (var i in rows) {
                    var row = rows[i];
                    if (row.name.indexOf(e.target.value) >= 0)
                        newRows.push(row);
                }
            ...
            __decorate([
                YA_core_2.reactive(YA_core_1.ReactiveTypes.Each)
            ], SampleComponent.prototype, "rowItem", void 0);
            __decorate([
                YA_core_1.template("")
        ...
        var elem = SampleComponent.$render(a, null, document.body);
    };
    //("YA.Core",{ 
    var proto = {
        ...
        "ObservableArray": function (assert, info) {
            ...
            assert(true, idx1 instanceof YA_core_2.Observable, "可以获取到item代理");
            assert(true, idx2 instanceof YA_core_2.Observable, "可以获取到item代理");
        ...
        "Schema": function (assert, info) {
            var initData = createData();
            var model = new YA_core_2.ObservableSchema();
            model.$init(initData);
