...
(function (factory) {
    ...
    var ObservableSchema = /** @class */ (function () {
        ...
        ObservableSchema.prototype.$defineProp = function (propname, initValue) {
            ...
            defineMember(this.$ctor, propname, function (owner, name) { return new propSchema.$ctor(owner, name); });
            return propSchema;
        };
        ObservableSchema.prototype.$initObservable = function (ob) {
            var _loop_1 = function (n) {
                var propSchema = this_1[n];
                defineMember(ob, n, function (owner, name) { return new propSchema.$ctor(owner, name); });
            };
            var this_1 = this;
            for (var n in this) {
                _loop_1(n);
