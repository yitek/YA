        ...
        ObservableObject.prototype.$prop = function (name, prop) {
            ...
            if (prop === false) {
                Object.defineProperty(this, name, {
                    ...
                    get: function () { return (_this.$modifiedValue === undefined ? _this.$target : (_this.$modifiedValue === Undefined ? null : _this.$modifiedValue))[name]; },
                    set: function (newValue) { return (_this.$modifiedValue === undefined ? _this.$target : (_this.$modifiedValue === Undefined ? null : _this.$modifiedValue))[name] = newValue; }
                });
                return this;
            }
