(function (factory) {
    ...
    (function (MemberTypes) {
        MemberTypes[MemberTypes["Value"] = 0] = "Value";
        MemberTypes[MemberTypes["Object"] = 1] = "Object";
        MemberTypes[MemberTypes["Array"] = 2] = "Array";
    ...
    class Model {
        ...
        createProxy(data) {
            ...
            if (this.type === MemberTypes.Value) {
                ...
                let item_convertor;
                if (this.item_model) {
                    item_convertor = (index, item_value, proxy) => this.item_model.createProxy(item_value);
                }
