...
export class SubjectTest {
    ...
    subscribeDefault(assert_statement:TAssertStatement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    subscribe(assert_statement:TAssertStatement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    subscribeTimes(assert_statement:TAssertStatement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    notifyNoSubscribe(assert_statement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    usubscribeDefault(assert_statement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    unsubscribeTopic(assert_statement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    unsubscribeMore(assert_statement){
        // 1 创建主题对象
        let ob = new YA.Subject<any>();
    ...
    invalidReference(assert_statement){
        //创建一个观察者对象，
        let observer = {
            lastEvent:null,
