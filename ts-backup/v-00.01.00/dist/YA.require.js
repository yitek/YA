        ...
        var Resource = /** @class */ (function (_super) {
            ...
            function Resource(url) {
                var _this = _super.call(this, function (ready, fail) {
                    ...
                    elem.onerror = function (err, ex) { console.error(err, ex, _this); fail(err, self); };
                    self._load();
                }) || this;
                _this.url = url;
                return _this;
        ...
        var RequireContext = /** @class */ (function () {
            function RequireContext(name, deps, factory) {
                ...
                setTimeout(function () {
                    ...
                    var args = [];
                    var wait_count = _this.deps.length + 1; //自己最后会调用一次tryResolve.
                    ...
                    for (var index in _this.deps)
                        (function (depname, idx) {
                            if (depname === "exports") {
                                ...
                                depModule.ready(function (value, mod) {
                                    args[idx] = value;
                                    tryResolve();
                                });
                            }
