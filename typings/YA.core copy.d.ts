...
export declare function observable<T>(initData: any, index?: string, subject?: any): Observable<T>;
...
export declare function createElements(arr: any[], container: IDomNode): IDomNode[];
export declare function bindDomAttr(element: IDomNode, attrName: string, attrValue: any, compInstance: IComponent): any;
